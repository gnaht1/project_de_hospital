...
DBT_ICEBERG_TABLES = [
    ...
    "silver_db.int_clinical__visits_by_patient_area",
    ...
    "silver_db.int_marketing__patient_source_attribution",
    "silver_db.int_marketing__referral_attribution",
    ...
    "gold_db.mart_clinical__monthly_order_set_usage",
    "gold_db.mart_clinical__monthly_patient_category",
    "gold_db.mart_clinical__monthly_patient_area_heatmap",
    ...
    "gold_db.mart_marketing__monthly_patient_source_segments",
    "gold_db.mart_marketing__monthly_patient_source_revenue",
    "gold_db.mart_marketing__monthly_refferrer_revenue",
    "gold_db.mart_marketing__monthly_referrer_visits",
