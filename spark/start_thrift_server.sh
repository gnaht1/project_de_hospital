#!/bin/bash
# ============================================================
#  Khởi chạy Spark Thrift Server (HiveServer2) với Iceberg + MinIO
#  Port mặc định: 10000 (dbt-spark sẽ kết nối vào đây)
# ============================================================

# --- CONFIG (đồng bộ với config.py) ---
MINIO_ENDPOINT="http://172.30.2.254:9000"
MINIO_ACCESS_KEY="admin"
MINIO_SECRET_KEY="12345678"
WAREHOUSE_PATH="s3a://hospital-datalake/iceberg_warehouse"
